...
/**
    * Function which finds the process id of the specified process.
...
int main(const int argc, char* argv[])
{
    ...
    {
        printf("[HELP] ject.exe <dll> <process>\n");
        return -1;
    }
    ...
    {
        printf("An error occurred when trying to find the target process.\n");
        return -1;
    }
